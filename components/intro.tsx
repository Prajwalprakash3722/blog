          ...
          <div className="relative">
            ...
            <button className="relative px-7 py-4 bg-[#1C2333] rounded-lg leading-none flex items-center divide-x divide-gray-600">
              <span className="flex items-center space-x-5">
                <a className="pr-6 text-gray-100 hover:text-indigo-400" href="https://www.devcoffee.me" target="_blank" rel="noreferrer">About me</a>
              </span>
              <div className="relative inline-block px-8 py-3 group">
                ...
                <span>
                  <ul className="absolute inset-0 flex items-center justify-center space-x-3 transition-opacity opacity-0 group-hover:opacity-100">
                    <li>
                      <a className="block transition-opacity rounded-full hover:opacity-90 focus:outline-none focus:opacity-75" href="https://twitter.com/prajwal_3722" target="_blank" rel="noreferrer">
                    ...
                    <li>
                      <a className="block transition-opacity rounded-full hover:opacity-90 focus:outline-none focus:opacity-75" href="https://github.com/Prajwalprakash3722" target="_blank" rel="noreferrer">
                        <span className="sr-only"> GitHub </span>
                        <svg className="w-5 h-5 bg-slate-50 rounded-full" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
