              ...
              <div className="relative inline-block px-8 py-3 group">
                ...
                <span>
                  <ul className="absolute inset-0 flex items-center justify-center space-x-3 transition-opacity opacity-0 group-hover:opacity-100">
                    <li>
                      <a className="block transition-opacity rounded-full hover:opacity-90 focus:outline-none focus:opacity-75" href="https://twitter.com/prajwal_3722" target="_blank">
                    ...
                    <li>
                      <a className="block transition-opacity rounded-full hover:opacity-90 focus:outline-none focus:opacity-75" href="https://github.com/Prajwalprakash3722" target="_blank">
